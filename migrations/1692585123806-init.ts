...
export class Init1692585123806 implements MigrationInterface {
	name = 'Init1692585123806';
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "user_entity" ADD CONSTRAINT "FK_fc41c06e95e4c3d4bae0b9806b3" FOREIGN KEY ("rol_id") REFERENCES "rol_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "product_entity" ADD CONSTRAINT "FK_8773e1f2f8d30d4c3dc5b7822e3" FOREIGN KEY ("category_id") REFERENCES "category_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "user_entity" ADD CONSTRAINT "FK_e3867e13698980b1af23d6fe8aa" FOREIGN KEY ("rolId") REFERENCES "rol_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
	}
}
